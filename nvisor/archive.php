        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h3><?php
                        if ( is_day() ) :
                            esc_html_e( 'Daily Archives: ', 'nvisor' );

                        elseif ( is_month() ) :
                            esc_html_e( 'Monthly Archives: ', 'nvisor' );

                        
                        elseif ( is_year() ) :
                            esc_html_e( 'Yearly Archives: ', 'nvisor' );
                        ...
                        elseif ( is_year() ) :
                            ...
                            esc_html_e( 'Archives', 'nvisor' );

                        endif;

                    ?></h3>
                    <span><a href="<?php echo esc_url(home_url('/')); ?>"><?php esc_html_e( 'Home', 'nvisor' )?></a> <?php esc_html_e( 'Archives', 'nvisor' )?></span>
                </div>
            </div>
        </div>
    </div>
