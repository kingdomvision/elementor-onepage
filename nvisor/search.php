...
<section class="bread-section">
    <div class="bread-content text-center">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h3><?php esc_html_e('Search Results For : ','nvisor' ); echo get_search_query(); ?></h3>
                    <span><a href="<?php echo esc_url(home_url('/')); ?>"><?php esc_html_e( 'Home', 'nvisor' )?></a> <?php esc_html_e( 'Search Results', 'nvisor' )?></span>
                </div>
            </div>
        </div>
    </div>
